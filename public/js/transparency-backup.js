...
class TransparencyReport {
  ...
  formatMarkdown(text) { if (!text) return ''; if (typeof marked !== 'undefined') { try { return marked.parse(text); } catch (error) { console.error('Markdown parsing error:', error); return text.replace(/\n/g, '<br>'); } } else { console.warn('Marked.js not loaded, using fallback'); return text.replace(/\n/g, '<br>'); } }
  }
